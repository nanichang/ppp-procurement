                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="budgetry_amount" value="{{ $plan->budgetry_amount }}" class="form-control" id="budgetry_amount">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="estimated_amount_in_naira" value="{{ $plan->estimated_amount_in_naira }}" class="form-control" id="estimated_amount_in_naira">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="advertisement_for_pre_qualification" value="{{ $plan->advertisement_for_pre_qualification }}" class="form-control" id="advertisement_for_pre_qualification">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mda_approval_No_objection_date" value="{{ $plan->mda_approval_No_objection_date }}" class="form-control" id="mda_approval_No_objection_date">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sec_approval" value="{{ $plan->sec_approval }}" class="form-control" id="sec_approval">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="arrival_of_goods" value="{{ $plan->arrival_of_goods }}" class="form-control" id="arrival_of_goods">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="final_inspection_acceptance">Inspection Final Acceptance:</label>
                                        <input type="date" name="final_inspection_acceptance" value="{{ $plan->final_inspection_acceptance }}" class="form-control" id="final_inspection_acceptance">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
