        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-info">
                <header class="panel-heading">
                    Viewing all Submissions - Consultancy
                </header>
                    ...
                    <table class="table table-striped b-t b-light">
                        <thead>
                            <tr>
                                ...
                                <th data-toggle="class">CONSULTANCY</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(getUserRole() == 'mda')
                                            ...
                                            @else
                                                Approved
                                                <a href="{{ route('create-plan-advert', $data['id']) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Adverts</a>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
