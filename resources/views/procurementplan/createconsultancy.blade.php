                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contract_amount" class="form-control" id="v">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="selection_method" class="form-control" id="selection_method">
                                    </div>
                                    <div class="form-group">
                                        <label for="budgetry_amount">Budgetary Amount in Naira:</label>
                                        <input type="number" name="budgetry_amount" class="form-control" id="budgetry_amount">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="prep_submissions_by_mda" class="form-control" id="prep_submissions_by_mda">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="advertisement_for_pre_qualification" class="form-control" id="advertisement_for_pre_qualification">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="lead_time_before_submission">Lead-Time Before Shortlist:</label>
                                        <input type="date" name="lead_time_before_submission" class="form-control" id="lead_time_before_submission">
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="mda_approval_2" class="form-control" id="mda_approval_2">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="submission_of_evaluation_technical_report" class="form-control" id="submission_of_evaluation_technical_report">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="mda_approval_3">MDA Approval:</label>
                                        <input type="date" name="mda_approval_3" class="form-control" id="mda_approval_3">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="opening_of_fin_proposal" class="form-control" id="opening_of_fin_proposal">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="submission_of_evaluation_report_technical_financial" class="form-control" id="submission_of_evaluation_report_technical_financial">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="negotiations">Negotiations:</label>
                                        <input type="date" name="negotiations" class="form-control" id="negotiations">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="mda_approval_No_objection_date">MDA Approval/ No Objection Date:</label>
                                        <input type="date" name="mda_approval_No_objection_date" class="form-control" id="mda_approval_No_objection_date">
                                    </div>
                                </div><div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="certifiable_amount_per_contract">Certifiable Amount per Contract:</label>
                                        <input type="text" name="certifiable_amount_per_contract" class="form-control" id="certifiable_amount_per_contract">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="sec_approval">SEC Approval:</label>
                                        <input type="date" name="sec_approval" class="form-control" id="sec_approval">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="mobilization_advance_payment" class="form-control" id="mobilization_advance_payment">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="submission_of_draft_report">Submission of Draft Report:</label>
                                        <input type="date" name="submission_of_draft_report" class="form-control" id="submission_of_draft_report">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="submission_of_final_report" class="form-control" id="submission_of_final_report">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="final_cost" class="form-control" id="final_cost">
                                    </div>
                                </div>
