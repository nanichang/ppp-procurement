...
{{--                        <a href="#viewdata" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> View Submissions</a>--}}
...
{{--                                            <a href="#addNewMDA" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Plan</a>--}}
                                        @else
            ...
            <div class="modal fade" id="viewdata">
                <div class="modal-dialog">
                    <form class="bs-example form-horizontal" method="get"  action="{{ route('procurementPlan.viewall', $data['year']) }}">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
