                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lumpsum" class="form-control" id="lumpsum">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="pre_post_qualification">Pre or Post Qualification Date:</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="submission_bid_eval_rpt" class="form-control" id="submission_bid_eval_rpt">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contract_amount_certified" class="form-control" id="contract_amount_certified">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="substantial_completion" class="form-control" id="substantial_completion">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="final_acceptance">Final Acceptance:</label>
                                        <input type="text" name="final_acceptance" class="form-control" id="final_acceptance">
                                    </div>
                                </div>
