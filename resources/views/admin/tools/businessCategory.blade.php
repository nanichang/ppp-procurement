...
<section class="hbox stretch">
    <section class="vbox">
        ...
        <section class="panel panel-info">
            ...
            <form class="bs-example form-horizontal" action="{{ route('deleteBusinessCategory') }}" method="POST">
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form class="bs-example form-horizontal" action="{{ route('storeBusinessCategory') }}" method="POST">
    {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
            <input type="text" class="form-control"  required name="name" placeholder=" Business Category" value="">
