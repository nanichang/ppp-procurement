      ...
      <section class="vbox">
          ...
          <section class="scrollable padder">
            ...
            <div class=" text-left-xs text-right pt40">
              <form action="{{action('PlanAdvertController@toggleAdvert', [$advert->id, 'active' ])}}" method="POST" id="updateAdvertForm">
                <div class=" text-left-xs text-right pt40" style="margin-bottom:10px">
                  ...
                  <button class="btn btn-rounded btn-sm btn-icon btn-success" id="approve" disabled="disabled" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Publish Advert"><i class="i i-like"></i></button>
                </div>
              </form>
              <form action="{{action('PlanAdvertController@toggleAdvert', [$advert->id, 'disabled' ])}}" method="POST" id="updateAdvertForm">
                <div class=" text-left-xs text-right">
                  <input type="hidden" name="_token" id="_token" value="{{{ csrf_token() }}}" />

                  <button  class="btn btn-rounded btn-sm btn-icon btn-danger" id="decline" disabled="disabled" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Unpublish Advert"><i class="i i-dislike"></i></button>
                </div>
              </form>
            </div>
