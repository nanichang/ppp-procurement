...
<br/>
    <div class="col-sm-8">
        ...
        <div class="panel-body">
            <form class="bs-example form-horizontal" action="{{ route('advert.payment.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                    <input type="amount" id="amount" name="amount"  class="form-control">
