      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <?php $image = isset(Auth::user()->profile_pic) ? Auth::user()->profile_pic : 'images/download.png' ?>
          ...
          <ul class="dropdown-menu animated fadeInRight">
            ...
            <li>
              <a href="{{ action('MDAController@getPasswordUpdate') }}" >Change Password</a>
            </li>
          </ul>
        </li>
      </ul>
                ...
                <nav class="nav-primary hidden-xs">
                  ...
                  <ul class="nav nav-main" data-ride="collapse">
                    ...
                    <li class="@yield('advertlists')">
                      ...
                      <ul class="nav dk">
                        <li  class="@yield('advertlists')">
                          <a href="{{action('PlanAdvertController@getMDAAdverts')}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>All Adverts</span>
                          </a>
                        </li>
                        <li class="@yield('advertlists')" >
                          <a href="{{action('PlanAdvertController@getMDAAdvertsByCategory', 1)}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>Construction/Works Adverts</span>
                          </a>
                        </li>
                        <li  class="@yield('advertlists')">
                          <a href="{{action('PlanAdvertController@getMDAAdvertsByCategory', 2)}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>Consultancy/Service Adverts</span>
                          </a>
                        </li>
                        <li class="@yield('advertlists')" >
                          <a href="{{action('PlanAdvertController@getMDAAdvertsByCategory', 3)}}"class="auto">
                            <i class="i i-dot"></i>
                        ...
                        <li class="@yield('advertlists')" >
                          <a href="{{ route('listMdaBidOpeningAdverts') }}" class="auto">
                            <i class="i i-dot"></i>
                    ...
                    <li class="@yield('procurement-plan')">
                        ...
                        <span class="pull-right text-muted">
                          ...
                          <i class="i i-circle-sm text-active"></i>
                              ...
                              <span class="font-bold">Procurement Plans</span>
                          </a>
                      </li>
