      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated fadeInRight">
            ...
            <li>
              <a href="{{ action('ContractorController@getPasswordUpdate') }}" >Change Password</a>
            </li>
          </ul>
        </li>
      </ul>
                  ...
                  <ul class="nav nav-main" data-ride="collapse">
                    ...
                    <li  class="@yield('registration')">
                      <a href="/contractor/registration" class="auto">
                        ...
                        <span class="font-bold">Company Registration</span>
                      </a>
                    </li>
                    ...
                    <li class="@yield('advertlists')">
                      ...
                      <ul class="nav dk">
                        <li  class="@yield('advertlists')">
                          <a href="{{action('PlanAdvertController@getPublishedAdverts')}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>All Adverts</span>
                          </a>
                        </li>
                        <li class="@yield('advertlists')" >
                          <a href="{{action('PlanAdvertController@getPublishedAdvertsByCategory', 1)}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>Construction/Works Adverts</span>
                          </a>
                        </li>
                        <li  class="@yield('advertlists')">
                          <a href="{{action('PlanAdvertController@getPublishedAdvertsByCategory', 2)}}" class="auto">
                            <i class="i i-dot"></i>
                            <span>Consultancy/Service Adverts</span>
                          </a>
                        </li>
                        <li class="@yield('advertlists')" >
                          <a href="{{action('PlanAdvertController@getPublishedAdvertsByCategory', 3)}}"class="auto">
                            <i class="i i-dot"></i>
                    ...
                    <li class="@yield('biddingdocuments')" >
                      ...
                      <li class="@yield('biddingdocuments')">
                        ...
                        <li class="@yield('transactions')" >
                          <a href="{{route('getbidDocumentsByUser')}}" class="auto">
                            <i class="i i-dot"></i>
                    ...
                    <li class="@yield('transactions')" >
                      ...
                      <ul class="nav dk">
                        ...
                        <li class="@yield('transactions')" >
                          <a href="{{route('getPurchasedBidsByUser')}}" class="auto">
                            <i class="i i-dot"></i>
                    ...
                    <li  class="@yield('awards')">
                      <a href="/contractor/awards" class="auto">
                        <i class="i i-statistics icon">
                        </i>
